...
{    
    ...
    scoreText =  this.add.text(25, 595, 'Score: '+player.score).setFontFamily('Poppins').setFontSize(18).setColor('#ffffff');
    this.add.text(630, 595, 'Lives:').setFontFamily('Poppins').setFontSize(18).setColor('#ffffff');
